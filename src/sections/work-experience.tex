\begin{multicols}{2} 
    ...
    \CvSection{Work Experiences}{
        \CvSectionEntry{R\&D Supervizor}{
            \textbf{Date:} 01/2018 - Present \\
            \textbf{Company:} Cantek Farminova - \textbf{Place:} Antalya \\
            ...
            Room-based Energy Concumption Prediction Project by Using Machine Learning \\
            Technologies I used while developing this project; \\
            Java, Spring Boot \\
            Python, Sklearn, Machine Learning, Regression Methods \\
            Cassandra, Postgresql \\
        }
        \CvSectionEntry{R\&D Lead Software Engineer}{
            \textbf{Date:} 01/2019 - 08/2020(1 year 8 months) \\
            \textbf{Company:} Cantek Cooling - \textbf{Place:} Antalya \\
            \textbf{Goal}: Development of Industrial Control Systems (ICS) and Early Warning Systems (EWS) with local
            device or cloud server based web applications for industrial storage and vertical plant factories. \\
            \textbf{Job Description:} \\
        ...
        \CvSectionEntry{R\&D Sn. Software Engineer}{
            \textbf{Date:} 07/2015 - 01/2019 (3 years 7 months) \\
            \textbf{Company:} Cantek Cooling - \textbf{Place:} Antalya \\
        ...
        \CvSectionEntry{Jr. Computer Engineer}{
            ...
            \textbf{Job Description:} \\
            It was a part-time job. Micro software installation and technical support task in 'Cyprus Mikro Destek' firm which \\
    ...
    \CvSection{Start-up Projects}{
        ...
        \CvSectionEntry{Goldigo (http://www.goldigo.net)}{
            ...
            This platform had been actively used by globaly. 
            It was chosen as the second most preferred online-gaming item platform by Wow players for a period.
        }
    }
