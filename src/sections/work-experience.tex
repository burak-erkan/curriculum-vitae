\begin{multicols}{2} 
    ...
    \CvSection{Work Experiences}{
        \CvSectionEntry{Lead R\&D Software Engineer}{
            ...
            \textbf{Goal}: Based on the existing architecture, a flexible and scalable architecture 
            solution was built and implemented from scratch. \\
            ...
            \textbf{Outcome}: A customizable system solution has been provided to solve the problems 
            in the old system and to meet the requirements requested by the users from the old system.
        }
